package net.thefluffycart.litavis.entity.ai.brain;
...
public class BurrowBrain {
    ...
    protected static Brain<?> create(BreezeEntity breeze, Brain<BreezeEntity> brain) {
        BurrowBrain.addCoreTasks(brain);
        BurrowBrain.addIdleTasks(brain);
        BurrowBrain.addFightTasks(breeze, brain);
